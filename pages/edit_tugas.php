<?php
include '../function/editProcess.php';
?>
...
<head>
    ...
    <title>To-Do List - Edit Tugas</title>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16">
            ...
            <p class="text-md font-normal text-gray-500 lg:text-lg dark:text-gray-400">
                Setiap tugas yang Anda tulis adalah langkah menuju kesuksesan!
            </p>
            ...
            <form action="" method="POST" class="text-lg">
                <div class="mb-5">
                    ...
                    <input type="text" id="judul" name="judul" value="<?php echo htmlspecialchars($row['judul']); ?>"
                        required
