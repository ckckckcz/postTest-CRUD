  ...
  return (function () {
    ...
    var t = {
        ...
        853: function (t, e, i) {
          ...
          function et(t) {
            ...
            return (
              ...
              (_ = M.y),
              p
                ? Object.assign({}, T, (((S = {})[D] = E ? "0" : ""), (S[x] = k ? "0" : ""), (S.transform = (O.devicePixelRatio || 1) <= 1 ? "translate(" + m + "px, " + _ + "px)" : "translate3d(" + m + "px, " + _ + "px, 0)"), S))
          ...
          var it = {
              ...
              fn: function (t) {
                ...
                null != e.modifiersData.popperOffsets &&
                  (e.styles.popper = Object.assign({}, e.styles.popper, et(Object.assign({}, c, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: a, roundOffsets: d })))),
                  null != e.modifiersData.arrow && (e.styles.arrow = Object.assign({}, e.styles.arrow, et(Object.assign({}, c, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: d })))),
          ...
          function Ot(t, e, i) {
            ...
            return (
              (o || (!o && !i)) &&
                (("body" !== L(e) || ut(s)) && (c = (n = e) !== I(n) && C(n) ? { scrollLeft: (r = n).scrollLeft, scrollTop: r.scrollTop } : ct(n)), C(e) ? (((l = z(e, !0)).x += e.clientLeft), (l.y += e.clientTop)) : s && (l.x = lt(s))),
          ...
          var gt = D(
            ...
            vt = D(
              '<div class="days">\n  <div class="days-of-week grid grid-cols-7 mb-1">'
                .concat(x("span", 7, { class: "dow block flex-1 leading-9 border-0 rounded-lg cursor-default text-center text-gray-900 font-semibold text-sm" }), '</div>\n  <div class="datepicker-grid w-64 grid grid-cols-7">')
                .concat(
                  x("span", 42, { class: "block flex-1 leading-9 border-0 rounded-lg cursor-default text-center text-gray-900 font-semibold text-sm h-6 leading-6 text-sm font-medium text-gray-500 dark:text-gray-400" }),
                  "</div>\n</div>"
                )
            ),
            yt = D(
                ...
                a(e, [
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      void 0 !== t.showDaysOfWeek && (t.showDaysOfWeek ? (ot(this.dow), this.calendarWeeks && ot(this.calendarWeeks.dow)) : (rt(this.dow), this.calendarWeeks && rt(this.calendarWeeks.dow))),
                        e &&
                    ...
                    value: function () {
                      ...
                      Array.from(this.grid.children).forEach(function (e, i) {
                        var n = e.classList,
                          ...
                          a = o.getDay();
                        if (
                          ((e.className = "datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 block flex-1 leading-9 border-0 rounded-lg cursor-pointer text-center text-gray-900 dark:text-white font-semibold text-sm ".concat(
                            t.cellClass
                          )),
                          (e.dataset.date = r),
                          ...
                          (r < t.minDate || r > t.maxDate || t.disabled.includes(r)) &&
                            (n.add("disabled", "cursor-not-allowed", "text-gray-400", "dark:text-gray-500"), n.remove("hover:bg-gray-100", "dark:hover:bg-gray-600", "text-gray-900", "dark:text-white", "cursor-pointer")),
                          t.daysOfWeekDisabled.includes(a) &&
                            (n.add("disabled", "cursor-not-allowed", "text-gray-400", "dark:text-gray-500"), n.remove("hover:bg-gray-100", "dark:hover:bg-gray-600", "text-gray-900", "dark:text-white", "cursor-pointer"), _(t.disabled, r)),
                  ...
                  value: function () {
                    ...
                    Array.from(this.grid.children).forEach(function (a, s) {
                      var d = a.classList,
                        c = I(t.year, s, 1);
                      if (
                        ((a.className = "datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 block flex-1 leading-9 border-0 rounded-lg cursor-pointer text-center text-gray-900 dark:text-white font-semibold text-sm ".concat(
                          t.cellClass
                        )),
            ...
            return a(
              function t(e) {
                ...
                n.classList.add("datepicker-".concat(y)),
                  ...
                  (this.views = [new bt(this), new wt(this), new Et(this, { id: 2, name: "years", cellClass: "year", step: 1 }), new Et(this, { id: 3, name: "decades", cellClass: "decade", step: 10 })]),
          ...
          var Zt = (function () {
            return a(
              function t(e) {
                ...
                var o = (this.config = Object.assign({ buttonClass: (i.buttonClass && String(i.buttonClass)) || "button", container: document.body, defaultViewDate: L(), maxDate: void 0, minDate: void 0 }, ft(et, this)));
        ...
        902: function (t, e, i) {
          ...
          var r = i(423),
            o = { alwaysOpen: !1, activeClasses: "bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white", inactiveClasses: "text-gray-500 dark:text-gray-400", onOpen: function () {}, onClose: function () {}, onToggle: function () {} },
          ...
          function d() {
            document.querySelectorAll("[data-drawer-target]").forEach(function (t) {
              ...
              if (i) {
                ...
                new s(i, { placement: n || o.placement, bodyScrolling: r ? "true" === r : o.bodyScrolling, backdrop: a ? "true" === a : o.backdrop, edge: d ? "true" === d : o.edge, edgeOffset: c || o.edgeOffset });
        ...
        16: function (t, e, i) {
          ...
          var r = i(423),
            o = { placement: "center", backdropClasses: "bg-gray-900/50 dark:bg-gray-900/80 fixed inset-0 z-40", backdrop: "dynamic", closable: !0, onHide: function () {}, onShow: function () {}, onToggle: function () {} },
            a = { id: null, override: !0 },
            s = (function () {
              function t(t, e, i) {
                void 0 === t && (t = null),
