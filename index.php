    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16">
            ...
            <?php if ($isDbConnectionSuccess) { ?>
                ...
                <div class="daftarCard grid grid-cols-4 gap-5 mt-6 md-6">
            ...
            <?php } else { ?>
                <div class="max-w-sm mx-auto mt-10">
                    <div class="bg-red-100 border border-red-400 text-red-700 rounded-lg p-6">
                        <h5 class="text-lg font-bold mb-3 text-center">Database Connection Failed!</h5>
